...
# set_1 = set(input(f'Введите {n} значений через пробел: ').split())
# set_2 = set(input(f'Введите {m} значений через пробел: ').split())
# for i in set_1:
#     for j in set_2:
#         if i == j:
#             print(i)
...
list_1 = input('Введите кол-во ягод, которые выросли на {n} кустах, через пробел: ').split()
